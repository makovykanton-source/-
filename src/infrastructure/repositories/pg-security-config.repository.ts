import { SecurityConfig, SecurityConfigRepository } from "../../application/ports/security-config.repository.js";
import { pgPool } from "../db/postgres.js";

export class PgSecurityConfigRepository implements SecurityConfigRepository {
  async findByGuildId(guildId: string): Promise<SecurityConfig | null> {
  ...
  async upsert(config: SecurityConfig): Promise<void> {
    await pgPool.query(
